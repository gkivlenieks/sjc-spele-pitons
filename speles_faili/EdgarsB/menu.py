...
def nospiests(none):
    ...
    print("Starta menu")
    global menu2, menu3
    menu2 = logs.create_rectangle(150, 400, 750, 500, fill="white", outline="blue")
    menu3 = logs.create_text(450, 450,  font=(None, 50), text="TIEŠĀM SĀKT SPĒLI")
    logs.tag_bind(menu1, "<Button-1>", nospiests2)
    logs.tag_bind(menu, "<Button-1>", nospiests2)
