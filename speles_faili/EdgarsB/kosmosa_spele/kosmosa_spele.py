...
def SakumaIzvelne(reize):
    ...
    #logs.tag_bind(menu2, "<Button-1>", nospiests3)
    #logs.tag_bind(menu3, "<Button-1>", nospiests3)
...
def nospiests2(none):
    ...
    #POGA UZ GRŪTO LĪMENI...

    #POGA UZ SĀKUMA IZVELNI???!!!
    p4 = logs.create_rectangle(150, 420, 750, 520, fill="white", outline="blue")
    p4t = logs.create_text(450, 470,  font=(None, 30), text="Atgriezties atpakaļ")
